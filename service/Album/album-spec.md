...
[EdgeCase]
  - albumA - artist1(main) 존재, albumA - artist2(main) 추가 -> externalId 값에 따라 판단. externalId 값이 없다면 albumA - artist2(main)을 별도 항목으로 추가(서로 다른 아티스트의 앨범인지 Various Artists 앨범의 서로 다른 두 곡인지 판단하기 어려움)
